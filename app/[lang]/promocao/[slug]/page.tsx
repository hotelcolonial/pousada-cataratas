      ...
      <section className="pp-prod">
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "14px", marginTop: "36px" }}>
            ...
            <a href={BOOKING_BASE} target="_blank" rel="noopener noreferrer" className="pp-resv" style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "54px", background: "#C79A6A", color: "#FFFFFF", textDecoration: "none", fontSize: "12px", letterSpacing: ".22em", textTransform: "uppercase", transition: "filter .15s ease" }}>{dict.promocaoProduct.reservarAgora}</a>
          </div>
        </div>
      </section>
