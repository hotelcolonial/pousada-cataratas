      ...
      <section className="pp-prod">
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "14px", marginTop: "36px" }}>
            <a href="https://wa.me/5545991377708" target="_blank" rel="noopener noreferrer" className="pp-wa" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", height: "54px", background: "#143C7A", color: "#FFFFFF", textDecoration: "none", fontSize: "12px", letterSpacing: ".22em", textTransform: "uppercase", transition: "filter .15s ease" }}>
